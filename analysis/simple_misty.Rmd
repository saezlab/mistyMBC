...
```{r run_misty, cache = TRUE, autodep = TRUE}
...
misty.results %>%
  ...
  plot_interaction_heatmap("intra", 2) %>%
  plot_interaction_heatmap("juxta.15", 2) %>%
  plot_interaction_heatmap("para.100", 2) %>%
  plot_contrast_heatmap("intra", "juxta.15", 2) %>%
  plot_contrast_heatmap("intra", "para.100", 2)
```
